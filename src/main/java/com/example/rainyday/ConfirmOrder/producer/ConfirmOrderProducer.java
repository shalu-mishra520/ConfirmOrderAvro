...
public class ConfirmOrderProducer {
	...
	String topic="order-details";

	/*
	 * public void sendLibraryEvents(LibraryEvent libraryevent) throws
	 * JsonProcessingException {
	 * 
	 * 
	 * 
	 * Integer key=libraryevent.getLibraryEventId(); String
	 * value=objMapper.writeValueAsString(libraryevent.getBook());
	 * 
	 ...
	 * ListenableFutureCallback<SendResult<Integer,String>>() {
	 * 
	...
	/*
	 * public void sendLibraryEvent_Appraoch(Record custRecord,Customer cust) throws
	 * JsonProcessingException {
	 * 
	 * logger.info("inside the event of producer");
	 * 
	 * Integer key= (Integer)cust.getCustId(); String
	 * value=objMapper.writeValueAsString(custRecord);
	 * logger.info("value in producer for customer:"+value);
	 * ProducerRecord<Integer,String>
	 * producerRecord=buildProducerRecord(key,value,topic);
	 * ListenableFuture<SendResult<Integer,String>>
	...
	/*
	 * public SendResult<Integer, String> sendLibraryEventsSynchronous(LibraryEvent
	 * libraryevent) throws JsonProcessingException { Integer key=
	 * libraryevent.getLibraryEventId(); String
	 * value=objMapper.writeValueAsString(libraryevent); SendResult<Integer,String>
	 * sendResult=null; try {
	 * sendResult=kafkaTemplate.sendDefault(key,value).get();//synchronous result;
	 * 
	 * }catch(ExecutionException |InterruptedException e) {
	 * logger.error("execution exception occured"+e.getMessage()); }catch(Exception
	 * e) { e.printStackTrace(); } return sendResult; }
	 * 
	 */
